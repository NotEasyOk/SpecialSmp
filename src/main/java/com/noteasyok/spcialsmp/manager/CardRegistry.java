...
public class CardRegistry {
    ...
    public static void registerAll() {
        ...
        register(new ArchitectCard(), List.of("§7Left: Bedrock Prison", "§7Right: Info", "§7Shift+R: Sky Gold Bridge"));
        register(new MirrorCard(), List.of("§7Left: Identity Thief", "§7Right: Info", "§7Shift+R: Damage Reflection"));
